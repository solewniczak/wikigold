...
def import_dump_command(lang, dump_date, early_stopping, mirror, download, decompress):
    ...
    db.commit()  # save dump into doatabase
    ...
    print('updating wikipedia_decisions destination_ids...', end=' ')
    start = time.time_ns()
    ...
    print('updating wikipedia_decisions label_ids...', end=' ')
    start = time.time_ns()
    sql_update_wikipedia_decisions = '''
    ...
    print('updating articles redirects...', end=' ')
    start = time.time_ns()
    ...
    print('updating articles counters...', end=' ')
    start = time.time_ns()
    ...
    print('saving labels_articles...', end=' ')
    start = time.time_ns()
